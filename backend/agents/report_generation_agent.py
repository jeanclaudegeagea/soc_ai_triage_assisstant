    ...
    def execute(self, 
        ...
        if attack_details:
            ...
            for idx, attack in enumerate(attack_details, 1):
                ...
                report.append("")
                report.append(f"Detected Patterns: {', '.join(attack.get('detected_patterns', ['Unknown']))}")
                report.append("")
        ...
        if correlation_results:
            ...
            for idx, corr in enumerate(correlation_results, 1):
                ...
                if fp_check.get('likely_false_positive'):
                    ...
                    report.append(f"Detected Patterns: {fp_check.get('detected_patterns', [])}")
                    report.append("")
        ...
        true_positives = [a for a in attack_details if "TRUE" in a.get('analysis', '').upper()]
